...
CONFIG="$SCRIPT_DIR/../configs/market/residual_fusion_imagenet.yml"
...
OUTPUT_DIR="${OUTPUT_DIR:-$SCRIPT_DIR/../../../runtime_logs/train_from_imagenet/residual_fusion_imagenet}"
