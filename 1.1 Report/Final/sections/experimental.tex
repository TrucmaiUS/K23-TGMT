...
Hình~\ref{fig:market_latency} trực quan hóa chi phí suy luận của các biến thể.
Hình~\ref{fig:market_validation_curve} cho thấy xu hướng hội tụ của các cấu
hình qua các lần validation trong quá trình huấn luyện.

\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/market_latency_ms.png}
    \caption{Độ trễ suy luận trung bình của các biến thể trên Market-1501.}
    \label{fig:market_latency}
\end{figure}
