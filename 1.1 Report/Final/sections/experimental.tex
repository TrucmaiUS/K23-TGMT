...
\bottomrule
\end{tabular*}
\caption{Kết quả so sánh trên Market-1501. Độ trễ được đo với batch size $1$ trên GPU NVIDIA RTX PRO 6000 Blackwell.}
...
\begin{figure*}[!t]
    ...
    \caption{Validation mAP theo các epoch trong quá trình huấn luyện.}
