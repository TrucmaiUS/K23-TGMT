...
Đề tài tập trung nghiên cứu bài toán \textbf{Person Re-identification (ReID)}
...
liệu chuẩn và đánh giá hiệu quả bằng các độ đo phổ biến. Bên cạnh đó, đề tài
cũng xem xét một số hướng cải tiến nhằm nâng cao hiệu quả nhận dạng.
...
Bài toán này được gọi là \textbf{Person Re-identification (ReID)}. Mục tiêu của
...
Tuy nhiên, Person Re-identification là một bài toán khó do sự thay đổi lớn về
góc nhìn, ánh sáng, tư thế, độ phân giải ảnh và hiện tượng che khuất giữa các
camera. Bên cạnh đó, sự tương đồng về trang phục hoặc ngoại hình giữa nhiều
...
trong bài toán Person Re-identification nhờ khả năng học đặc trưng trực tiếp từ
dữ liệu. Tuy vậy, hiệu quả của mô hình vẫn chịu ảnh hưởng bởi sự đa dạng của dữ
...
giải quyết bài toán này như thế nào, mô hình nào phù hợp để áp dụng trong phạm
vi đồ án, và những cải tiến nào có thể giúp nâng cao hiệu quả nhận dạng khi
