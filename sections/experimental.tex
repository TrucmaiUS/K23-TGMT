...
Gán trọng số ở mức JPM & Gán trọng số trê   n các nhánh cục bộ của JPM & 88.6 & 95.0 \\
...
\cmidrule(lr){1-4}
Thay thế trực tiếp đặc trưng toàn cục & Thay trực tiếp đặc trưng toàn cục bằng đặc trưng patch đã được gán trọng số & 64.0 & 81.8 \\
...
\subsubsection{Biến thể hiệu chỉnh residual có cổng}
